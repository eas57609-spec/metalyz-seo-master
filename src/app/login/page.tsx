...
import { Mail, Lock, Eye, EyeOff, Loader2, Chrome, Sparkles } from 'lucide-react';
import { useAuthStore } from '@/lib/auth-store';

export default function LoginPage() {
  const router = useRouter();
  const { login, loginWithGoogle, isLoading, setRememberMe, rememberMe } = useAuthStore();
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Welcome to Metalyz</h1>
          <p className="text-gray-400">Sign in to boost your SEO performance</p>
        </div>
